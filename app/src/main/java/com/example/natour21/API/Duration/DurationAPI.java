...
public class DurationAPI {
    ...
    public static void insertDuration(Activity activity, String duration,int minutes, String accessToken, VolleyCallback volleyCallback) {

        String url = Config.BASE_URL + Config.API + Config.INSERTDURATION;
